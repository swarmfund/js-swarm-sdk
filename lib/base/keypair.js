...
class Keypair {
  ...
  static fromRawSeed(rawSeed) {
    ...
    let keys = _tweetnacl2.default.sign.keyPair.fromSeed(rawSeedU8);
   ...
   */
  static random() {
    let seed = _tweetnacl2.default.randomBytes(32);
  ...
  xdrAccountId() {
    return new _xdr_generated2.default.AccountId.keyTypeEd25519(this._publicKey);
  }

  xdrBalanceId() {
    return new _xdr_generated2.default.BalanceId.keyTypeEd25519(this._publicKey);
  }

  xdrPublicKey() {
    return new _xdr_generated2.default.PublicKey.keyTypeEd25519(this._publicKey);
  }
  ...
  signDecorated(data) {
    ...
    return new _xdr_generated2.default.DecoratedSignature({ hint, signature });
  }
}
