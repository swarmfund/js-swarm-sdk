...
class Operation extends _base_operation.BaseOperation {
  /**
  ...
  static createAccount(opts) {
    ...
    if (!(0, _isUndefined2.default)(opts.accountPolicies)) {
    ...
    attributes.ext = new _xdr_generated2.default.CreateAccountOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion());
    let createAccount = new _xdr_generated2.default.CreateAccountOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.createAccount(createAccount);
  ...
  static payment(opts) {
    ...
    if (!(0, _isUndefined2.default)(opts.feeData)) {
      let sourceFee = new _xdr_generated2.default.FeeData({
        ...
        ext: new _xdr_generated2.default.FeeDataExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
      });
      let destinationFee = new _xdr_generated2.default.FeeData({
      ...
      attributes.feeData = new _xdr_generated2.default.PaymentFeeData({
        sourceFee,
        destinationFee,
        sourcePaysForDest: opts.feeData.sourcePaysForDest,
        ext: new _xdr_generated2.default.PaymentFeeDataExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
      });
    } else {
    ...
    if (!(0, _isUndefined2.default)(opts.invoiceReference)) {
      let invoiceReference = new _xdr_generated2.default.InvoiceReference({
        invoiceId: _jsXdr.UnsignedHyper.fromString(opts.invoiceReference.invoiceId),
        accept: opts.invoiceReference.accept,
        ext: new _xdr_generated2.default.InvoiceReferenceExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
      });
    ...
    attributes.ext = new _xdr_generated2.default.PaymentOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion());
    let payment = new _xdr_generated2.default.PaymentOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.payment(payment);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static directDebit(opts) {
    ...
    attributes.ext = new _xdr_generated2.default.DirectDebitOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion());
    let directDebit = new _xdr_generated2.default.DirectDebitOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.directDebit(directDebit);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static recover(opts) {
    ...
    let attributes = {
      ext: new _xdr_generated2.default.RecoverOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    let recover = new _xdr_generated2.default.RecoverOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.recover(recover);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static setFees(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.SetFeesOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    if (!(0, _isUndefined2.default)(opts.fee)) {
      ...
      if ((0, _isUndefined2.default)(opts.fee.feeType)) {
        throw new TypeError('feeType must be defined');
      }
      if (!(opts.fee.feeType instanceof _xdr_generated2.default.FeeType)) {
      ...
      if ((0, _isUndefined2.default)(opts.fee.period)) {
        opts.fee.period = '0'; // <<clear
      }
      if ((0, _isUndefined2.default)(opts.fee.subtype)) {
        opts.fee.subtype = '0';
      }
      if ((0, _isUndefined2.default)(opts.fee.lowerBound)) {
        opts.fee.lowerBound = '0';
      }
      if ((0, _isUndefined2.default)(opts.fee.upperBound)) {
      ...
      let feeData = {
        ...
        ext: new _xdr_generated2.default.FeeEntryExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
      };
      ...
      let entry = new _xdr_generated2.default.FeeEntry(feeData);
      attributes.fee = entry;
    }

    if ((0, _isUndefined2.default)(opts.isDelete)) {
      attributes.isDelete = false;
    } else {
      attributes.isDelete = opts.isDelete;
    }

    let setfees = new _xdr_generated2.default.SetFeesOp(attributes);
    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.setFee(setfees);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static manageAccount(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ManageAccountOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    attributes.account = _keypair.Keypair.fromAccountId(opts.account).xdrAccountId();
    if ((0, _isUndefined2.default)(opts.blockReasonsToAdd)) {
      opts.blockReasonsToAdd = 0;
    }
    if ((0, _isUndefined2.default)(opts.blockReasonsToRemove)) {
      opts.blockReasonsToRemove = 0;
    }

    if ((0, _isUndefined2.default)(opts.accountType)) {
    ...
    let manageAccountOp = new _xdr_generated2.default.ManageAccountOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.manageAccount(manageAccountOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static manageBalance(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ManageBalanceOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };

    if (!_keypair.Keypair.isValidPublicKey(opts.destination)) {
      throw new Error('account is invalid');
    }
    if (!(opts.action instanceof _xdr_generated2.default.ManageBalanceAction)) {
    ...
    let manageBalanceOp = new _xdr_generated2.default.ManageBalanceOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.manageBalance(manageBalanceOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static reviewPaymentRequest(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ReviewPaymentRequestOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };

    if ((0, _isUndefined2.default)(opts.paymentId)) {
      throw new Error('paymentId should be defined');
    }
    if ((0, _isUndefined2.default)(opts.accept)) {
      throw new TypeError('accept should be defined');
    }

    if (!(0, _isUndefined2.default)(opts.rejectReason)) {
    ...
    let reviewPaymentRequestOp = new _xdr_generated2.default.ReviewPaymentRequestOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.reviewPaymentRequest(reviewPaymentRequestOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static manageAssetPair(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ManageAssetPairOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    if (!(opts.action instanceof _xdr_generated2.default.ManageAssetPairAction)) {
      throw new TypeError('action argument should be value of xdr.ManageAssetPairAction enum');
    }

    if ((0, _isUndefined2.default)(opts.policies)) {
    ...
    let manageAssetPairOp = new _xdr_generated2.default.ManageAssetPairOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.manageAssetPair(manageAssetPairOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static manageInvoice(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ManageInvoiceOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    if ((0, _isUndefined2.default)(opts.invoiceId)) {
    ...
    let manageInvoiceOp = new _xdr_generated2.default.ManageInvoiceOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.manageInvoice(manageInvoiceOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static setLimits(opts = {}) {
    let attributes = {
      ext: new _xdr_generated2.default.SetLimitsOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion()),
      limits: new _xdr_generated2.default.Limits({
    ...
    let setLimitsOp = new _xdr_generated2.default.SetLimitsOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.setLimit(setLimitsOp);
    Operation.setSourceAccount(opAttributes, opts);
    return new _xdr_generated2.default.Operation(opAttributes);
  }
  ...
  static operationToObject(operation) {
    ...
    switch (operation.body().switch()) {
      case _xdr_generated2.default.OperationType.createAccount():
        ...
        break;
      case _xdr_generated2.default.OperationType.payment():
        ...
        break;
      case _xdr_generated2.default.OperationType.directDebit():
        ...
        break;
      case _xdr_generated2.default.OperationType.setOption():
        _set_options_builder.SetOptionsBuilder.setOptionsToObject(result, attrs);
        break;
      case _xdr_generated2.default.OperationType.setFee():
        if (!(0, _isUndefined2.default)(attrs.fee())) {
          result.fee = {};
        ...
        break;
      case _xdr_generated2.default.OperationType.manageAccount():
        ...
        result.accountType = attrs.accountType().value;
        break;
      case _xdr_generated2.default.OperationType.manageBalance():
        result.action = attrs.action();
        result.destination = accountIdtoAddress(attrs.destination());
        result.asset = attrs.asset();
        break;
      case _xdr_generated2.default.OperationType.reviewPaymentRequest():
      ...
      case _xdr_generated2.default.OperationType.setLimit():
        ...
        break;
      case _xdr_generated2.default.OperationType.manageOffer():
        _manage_offer_builder.ManageOfferBuilder.manageOfferOpToObject(result, attrs);
        break;
      case _xdr_generated2.default.OperationType.manageInvoice():
        result.amount = Operation._fromXDRAmount(attrs.amount());
        ...
        break;
      case _xdr_generated2.default.OperationType.manageAssetPair():
        result.action = attrs.action();
