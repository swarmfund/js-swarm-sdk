...
exports.ManageOfferBuilder = undefined;
...
class ManageOfferBuilder {
  ...
  static manageOffer(opts) {
    let attributes = {
      ext: new _xdr_generated2.default.ManageOfferOpExt(_xdr_generated2.default.LedgerVersion.emptyVersion())
    };
    ...
    if ((0, _isUndefined2.default)(opts.orderBookID)) {
      opts.orderBookID = '0';
    }
    ...
    let manageOfferOp = new _xdr_generated2.default.ManageOfferOp(attributes);

    let opAttributes = {};
    opAttributes.body = _xdr_generated2.default.OperationBody.manageOffer(manageOfferOp);
